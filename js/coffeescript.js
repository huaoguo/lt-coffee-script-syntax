(function () {
  ...
  var atoms = [
    'true', 'false', 'null', 'undefined', 'yes', 'on', 'no', 'off', 'Infinity', 'NaN'
  ];
  ...
  CodeMirror.defineSimpleMode('coffeescript', {
    ...
    start: [
      ...
      { regex: '->|require|exports|module', token: 'variable' }, // method definition and commonjs
      ...
      { regex: /[A-Z]\w*/, token: 'variable' }, // capital variable always be class or module
      { regex: /(\([^\(\)]*\))\s*(?=->)/, token: 'def' }, // method signature
